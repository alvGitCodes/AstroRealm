...
function renderizarMapaAstral(dados) {
    ...
    ascendente.innerHTML = '♁ Ascendente em ' + decimalToDMS(dados.data.first_house.position) + ' ' + getSignoCerto(dados.data.first_house.sign) + ' ' + getNomeCompletoSigno(dados.data.first_house.sign);
...
renderizarMapaAstral(resultado);